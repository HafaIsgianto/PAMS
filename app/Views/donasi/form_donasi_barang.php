                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">
                                        <?= isset($donasi) ? 'Edit Donasi Barang' : 'Tambah Donasi Barang'; ?>
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <form action="<?= base_url() ?>donasi/saveDonasiBarang" method="post">
                                        <?= csrf_field(); ?>
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="nama_barang" name="nama_barang" placeholder="Nama Barang" value="<?= isset($donasi) ? $donasi['nama_barang'] : ''; ?>" required>
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small">
                                        <a href="<?= base_url('donasi_barang') ?>">Kembali ke Daftar Donasi Barang</a>
                                    </div>
                                </div>
                            </div>
                        </div>
